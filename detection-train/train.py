...
# 训练模型
results = model.train(data='/home/industai/code_folder/Python_code/gitlab_project/ultralytics/detection-train/gwbsmerge.yaml', 
                      #epochs=100, imgsz=640,batch=16,device=1,close_mosaic=0,rect=False)
                      epochs=100, imgsz=640,batch=16,device=1,rect=False,val=False,workers=4)